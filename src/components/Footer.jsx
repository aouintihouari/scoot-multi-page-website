...
const Footer = () => {
  return (
    <footer className="mono relative bottom-0 mt-[30%] w-full font-bold sm:mt-[20%] lg:mt-[10%]">
      <section className="relative flex h-[320px] w-full flex-col justify-evenly bg-[#495567] sm:flex-col md:justify-between md:px-[15%] md:py-[5%] lg:flex-row">
        <h3 className="mono mx-auto mb-[-2rem] text-center text-[32px] leading-[32px] font-bold tracking-[-1.43px] text-white sm:w-[60%] sm:text-[48px] sm:leading-[48px] sm:tracking-[-2.14px] md:mx-auto md:w-[70%] md:text-center lg:mx-0 lg:w-[40%] lg:text-left">
          Sign up and Scoot off today
        </h3>
        <div className="flex justify-center gap-4">
          <img
            className="block h-[40px] w-[113.57px] md:h-[56px] md:w-[159px]"
            src="./assets/icons/app-store.svg"
            alt="app store icon"
          />
          <img
            className="h-[40px] w-[130px] md:h-[56px] md:w-[182px]"
            src="./assets/icons/google-play.svg"
            alt="google play icon"
          />
        </div>
        <svg
          className="absolute bottom-0 left-[-135%] sm:left-[-30%] md:right-[-10%] md:left-auto"
      ...
      <section className="items center flex w-full flex-col bg-[#333A44] py-20 text-center text-[#939CAA] sm:flex-row sm:justify-between sm:px-[5%] md:px-[15%] md:py-10">
        <div className="sm:mr-[20%] sm:flex">
          <svg
            className="mx-auto sm:mx-0 sm:my-[-2%]"
            xmlns="http://www.w3.org/2000/svg"
            width="108"
            height="29"
          >
          ...
          <ul className="sm:mx-10 sm:flex">
            <li className="my-5 mt-10 cursor-pointer duration-300 hover:text-[#FCB72B] sm:mx-[10%] sm:my-0">
              <NavLink to="/about">About</NavLink>
            </li>
            <li className="my-5 cursor-pointer duration-300 hover:text-[#FCB72B] sm:mx-[10%] sm:my-0">
        ...
        <div className="mt-10 flex justify-center gap-4 sm:my-0">
          <svg
            className="cursor-pointer text-[#FCB72B] duration-300 hover:text-[#E5ECF4]"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
          >
